...
function Recruit({ collection, tokenMint, tokenAddress, tokenBalance, nftBalance, fetchNFTBalance, checkNFTBalance, listedNFTs, allListings, ownedNFTs }: RecruitProps) {
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold text-[#C4A484]">{requiredAmount} {collection.token_symbol}</p>
                                </div>
                            </div>
                            <div>
