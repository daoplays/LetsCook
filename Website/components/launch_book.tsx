...
export function LaunchBook({newLaunch, ListGameOnArena, setScreen} : {newLaunch : MutableRefObject<LaunchDataUserInput>, ListGameOnArena: MouseEventHandler<HTMLParagraphElement>, setScreen: Dispatch<SetStateAction<Screen>>}) {
