...
interface FeaturedBannerCollectionProps {
    featuredLaunch: LaunchData;
    isHomePage?: boolean;
}

const FeaturedBannerCollection = ({ featuredLaunch, isHomePage }: FeaturedBannerCollectionProps) => {
...
export default FeaturedBannerCollection;
